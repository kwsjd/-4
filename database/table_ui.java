...
public class table_ui extends JDialog {
    ...
    private functions db = new functions();

    public table_ui(Connection conn) {
    ...
    public void populateTable(Connection conn, JTable table) {
        try {
            ...
            ResultSet rs = stmt.executeQuery("select * from flats;");
